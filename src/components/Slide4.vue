<template>
	<div class="slide">
		<h1 class="slide-title">Slide 4: VueJS 3 Components</h1>

		<h2 class="sub-title">Defining Components and Their Significance</h2>
		<div class="content">
			<p>
				In VueJS, components are fundamental building blocks that
				encapsulate a part of your user interface, making your code more
				modular and maintainable.
			</p>
			<p>
				They allow you to create reusable, self-contained units of
